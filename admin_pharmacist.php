...
$user=$_POST['username'];
$pas=$_POST['password'];
$sql1=mysqli_query("SELECT * FROM pharmacist WHERE username='$user'",$con)or die(mysqli_error());
...
VALUES('$fname','$lname','$sid','$postal','$phone','$email','$user','$pas',NOW())",$con);
...
<hr/>	
    <div class="tabbed_area">  
       ...
       $result = mysqli_query("SELECT * FROM pharmacist",$con)or die(mysqli_error());
